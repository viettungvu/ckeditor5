...
export default class PlaceholderUI extends Plugin {
  ...
  _createListView() {
    ...
    listView.set({
      role: "menu",
      class: [xplaceholder.AUTHOR_CLASS, "ck", "ck-placeholder-list"],
    });
    ...
    const items = placeholders.map((type) => {
      ...
      buttonView.set({
        label: type.text,
        withText: true,
        class: [xplaceholder.AUTHOR_CLASS, "ck", "ck-button__label"],
      });
      listItem.setTemplate({
        tag: "li",
        attributes: {
          class: [xplaceholder.AUTHOR_CLASS, "ck", "ck-list__item"],
        },
        children: [buttonView],
      });
      listItem.set({
